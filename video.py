...
def main():
    ...
    audio_path = r'C:\Users\DELL\OneDrive\Desktop\translate\pranay_roy.wav'
    output_path = r'C:\Users\DELL\OneDrive\Desktop\translate\transvideo.mp4'
    voiceover_path = 'temppranay.mp3'
 
    extract_audio(video_path, audio_path)
    text = speech_to_text(audio_path)
    translated_text = translate_text(text)
    voiceover = generate_voiceover(translated_text, language='te')  # Change 'hi' to the desired language code
